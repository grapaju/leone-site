...
function DifferentialCard({ differential, index }) {
  ...
  return (
    <motion.div
      ...
      className="glass-subtle rounded-[20px] p-8 hover:shadow-xl hover:shadow-gold/5 transition-all duration-500 group"
    >
      {/* Icon */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -right-8 glass-form rounded-2xl p-6 max-w-xs"
            >
              <div className="flex items-center gap-4">
                <div className="text-4xl font-light text-gold">20+</div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              <div>
                <div className="text-3xl font-light text-gold mb-1">50+</div>
                <div className="text-xs text-light/60 uppercase tracking-wider">Empreendimentos</div>
              </div>
              <div>
                <div className="text-3xl font-light text-gold mb-1">100%</div>
                <div className="text-xs text-light/60 uppercase tracking-wider">Satisfação</div>
              </div>
              <div>
                <div className="text-3xl font-light text-gold mb-1">20+</div>
                <div className="text-xs text-light/60 uppercase tracking-wider">Anos</div>
              </div>
            </div>
          </motion.div>
        </div>
