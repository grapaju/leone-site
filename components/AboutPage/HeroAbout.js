...
export function HeroAbout() {
  ...
  return (
    <section 
      ref={ref}
      className="relative min-h-[75vh] flex items-center justify-start py-32 md:py-40 px-4 sm:px-6 overflow-hidden"
      style={{
      ...
      <div className="container mx-auto max-w-[1120px] relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            transition={isMobile ? { duration: 0 } : { duration: 0.9, delay: 0.2, ease: 'easeOut' }}
          ...
          <motion.p
            ...
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={isMobile ? { duration: 0 } : { duration: 0.7, delay: 0.3, ease: 'easeOut' }}
          >
            {t('subtitle')}
          </motion.p>
        </motion.div>
